const repeatedWord=require('./hashmap-repeated-word').repeatedWord;
...
describe('testing repeatedWord function', () => {
    ...
    it('should successfully output the first repeated word from the string', () => {
      let test = repeatedWord(testOne);
  
      expect(test).toEqual('a');
    });
  
    it('should successfully output the first repeated word from the string', () => {
      let test = repeatedWord(testTwo);
  
      expect(test).toEqual('it');
    });
  
    it('should successfully output the first repeated word from the string', () => {
      let test = repeatedWord(testThree);
